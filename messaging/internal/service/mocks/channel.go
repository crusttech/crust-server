...
// Source: messaging/internal/service/channel.go
...
func (m *MockChannelService) With(ctx context.Context) service.ChannelService {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "With", ctx)
	ret0, _ := ret[0].(service.ChannelService)
	return ret0
}
